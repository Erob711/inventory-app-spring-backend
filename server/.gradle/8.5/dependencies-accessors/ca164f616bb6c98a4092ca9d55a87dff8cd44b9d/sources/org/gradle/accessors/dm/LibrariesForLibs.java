...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    public static class OrgHibernateLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Returns the group of libraries at org.hibernate.orm
         */
    ...
    public static class OrgHibernateOrmLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Returns the group of libraries at org.hibernate.orm.hibernate
         */
    ...
    public static class OrgHibernateOrmHibernateLibraryAccessors extends SubDependencyFactory {
         ...
         * with versionRef 'org.hibernate.orm.hibernate.core'.
    ...
    public static class OrgSpringframeworkBootSpringBootStarterDataLibraryAccessors extends SubDependencyFactory {
        ...
        public OrgSpringframeworkBootSpringBootStarterDataLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
            ...
            /**
             * Creates a dependency provider for jdbc (org.springframework.boot:spring-boot-starter-data-jdbc)
         * with versionRef 'org.springframework.boot.spring.boot.starter.data.jdbc'.
             * This dependency was declared in catalog libs.versions.toml
             */
    ...
    public static class OrgHibernateVersionAccessors extends VersionFactory  {
        ...
        /**
         * Returns the group of versions at versions.org.hibernate.orm
         */
    ...
    public static class OrgHibernateOrmVersionAccessors extends VersionFactory  {
        ...
        /**
         * Returns the group of versions at versions.org.hibernate.orm.hibernate
         */
    ...
    public static class OrgHibernateOrmHibernateVersionAccessors extends VersionFactory  {
        ...
        public OrgHibernateOrmHibernateVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: org.hibernate.orm.hibernate.core (6.4.1.Final)
    ...
    public static class OrgSpringframeworkBootSpringBootVersionAccessors extends VersionFactory  {
        ...
        public OrgSpringframeworkBootSpringBootVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: org.springframework.boot.spring.boot.devtools (3.2.0)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
    ...
    public static class OrgSpringframeworkBootSpringBootStarterDataVersionAccessors extends VersionFactory  {
        ...
        public OrgSpringframeworkBootSpringBootStarterDataVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: org.springframework.boot.spring.boot.starter.data.jdbc (3.2.0)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
    ...
    public static class OrgSpringframeworkSecuritySpringSecurityVersionAccessors extends VersionFactory  {
        ...
        public OrgSpringframeworkSecuritySpringSecurityVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: org.springframework.security.spring.security.test (6.2.0)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
